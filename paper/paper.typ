...
Las industrias extractivas no reguladas están entre las principales fuentes de contaminación ambiental en la actualidad @crespo-lopezMercuryAmazonDanger2023, y la minería de superficie es uno de sus casos más visibles: la remoción acelerada de la cobertura forestal primigenia destruye hábitats terrestres e introduce sustancias tóxicas persistentes en las cuencas hidrográficas adyacentes @balaniukMiningTailingsDam2020. Esa alteración química del agua no se queda solo en el ecosistema, también afecta la salud pública y los medios de vida de las poblaciones que dependen de esos ríos.

A escala más amplia, la pérdida continua de bosques primarios altera el equilibrio térmico regional y acelera la pérdida de biodiversidad en los trópicos. La deforestación a gran escala interrumpe además los ciclos hidrológicos y reduce la capacidad de retención de carbono del bosque, mientras que los ecosistemas acuáticos acumulan sedimentos pesados por el lavado constante de suelos mineros. La restauración de estos espacios no es un proceso rápido: recuperar la capa fértil perdida toma décadas.
...
En la cuenca amazónica, esta extracción aurífera artesanal e ilegal recibe la denominación regional de garimpo @IllegalMiningAmazon2021. Solo en el territorio brasileño, la superficie deforestada por esta actividad creció un 1,200% entre 1985 y 2022 @ferreiranetoUncontrolledIllegalMining2024, invadiendo de forma agresiva áreas naturales protegidas y territorios indígenas legalmente reconocidos; la maquinaria pesada empleada remueve toneladas de suelo aluvial y altera la morfología natural de los ríos.

El caso peruano no es ajeno a este problema. En el departamento de Madre de Dios, la minería aluvial no regulada ha sido documentada como una crisis sanitaria @PerusGoldRush2016, principalmente por el uso intensivo de mercurio para la amalgama del oro, que contamina de forma severa los ríos amazónicos peruanos @CaseFloatingGold2022. Las emisiones atmosféricas de este metal pesado se depositan en el follaje forestal y se bioacumulan en la cadena trófica @gersonAmazonForestsCapture2022, al punto que evaluaciones clínicas han confirmado intoxicación crónica en peces de consumo diario y en pobladores locales.
...
Si se observa el conjunto de los doce trabajos revisados, el monitoreo satelital de minería ilegal ha pasado por varias etapas: primero dominaron los clasificadores estadísticos tradicionales, con buen desempeño pero alta sensibilidad a la nubosidad tropical @loboMappingMiningAreas2018 @debemChangeDetectionDeforestation2020; después aparecieron el radar SAR y los enfoques de fusión multimodal como respuesta directa a ese problema de nubosidad @lemesnetoSARBasedMonitoringIllegal2026 @pasanisiUsingHighResolutionSatellite2025; y más recientemente se ha ido migrando hacia arquitecturas profundas de segmentación y atención visual, aunque estas exigen una potencia computacional que no todas las agencias regionales pueden costear @hejmanowskaPotentialUNetDetecting2025 @radVisionTransformerMultispectral2024. Pese a este recorrido, ninguno de estos trabajos resuelve del todo el caso específico de la minería aluvial en la Amazonía sudamericana: varios adolecen de problemas de generalización frente a la alta movilidad de los campamentos en selvas prístinas, otros dependen de costos computacionales inasumibles para agencias locales, y los que sí abordan directamente el garimpo amazónico se han limitado a evaluar una sola arquitectura liviana, sin contrastar modelos residuales más profundos sobre un dataset masivo. Es justamente esa brecha la que este trabajo busca cerrar, desarrollando y validando una arquitectura residual ResNet50 optimizada mediante Transfer Learning sobre los 111,584 recortes satelitales de Amazonia Garimpo Binario @grupioniDeteccaoGarimpoNa2026, con la intención de aportar un sistema robusto, de bajo costo de inferencia y con escalabilidad operativa real para apoyar los esfuerzos gubernamentales de interdicción ambiental.
